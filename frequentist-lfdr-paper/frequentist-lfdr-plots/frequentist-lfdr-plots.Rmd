---
title: "Plots for frequentist lfdr paper"
output:
...
if (file.exists(rds_file)) {perm.pvals <- readRDS(rds_file)} else {
  ...
  fdrmod <- fdrtool(strat.test$p_values, statistic="pvalue",plot=FALSE,verbose=FALSE)
...
lfdr_strim <- fdrtool(perm.pvals, statistic="pvalue",plot=FALSE,verbose=FALSE)
...
\pagebreak
########### Figure 6: Scatterplot of clfdr versus mlfdr with m=1000 tests
...
########### Figure 7: Small experiment to illustrate clfdr with m=6 tests
...
\pagebreak
########### Larger experiment to show clfdr and mlfdr are close to the local FDP (Old manuscript)
